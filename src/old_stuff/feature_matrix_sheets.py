...
from src.pdb.constants import RE_PDB
from src.old_stuff.WindowExtractorSheets import WindowExtractorSheets
...
def torsion_angles(pdb_dir):
    ...
    for pdb_file in pdb_paths:
        ...
        window_extractor = WindowExtractorSheets(struc, pdb_file)
